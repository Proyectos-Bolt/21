...
function App() {
  ...
  const calculateFare = useCallback((distanceKm: number, waitingMinutes: number, sorianaBonus: boolean = false) => {
    ...
    return costoAcumuladoParadas + fare + (waitingMinutes * RATES.waitingRate) + sorianaExtraFee + petExtraFee + servicioEspecialFee + personasExtrasFee + tripTypeExtraFee;
  }, [selectedTripType, selectedSubTrip, petConfig, servicioEspecialConfig, personasExtrasConfig, costoAcumuladoParadas]);
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-2xl text-green-400">
                          ${(() => {
                            ...
                            const totalFinal = lastTripSummary.costoParadas + distanceCost + waitingCost + sorianaBonus + petCost + servicioEspecialCost + personasExtrasCost + tripTypeExtraFee;
          ...
          {tripData.isRunning && currentPosition && (
            <div className="mt-4 bg-gradient-to-r from-purple-800 to-purple-900 text-white p-3 rounded-xl text-center border border-purple-500 shadow-lg">
              <div className="text-xs">
                ...
                <div>Personas extras: {personasExtrasConfig.active ? `+$${personasExtrasConfig.cost} (${personasExtrasConfig.type === 'niño' ? 'niño' : 'adulto'})` : 'Inactivo'}</div>
